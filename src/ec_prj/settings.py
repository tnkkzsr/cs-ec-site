"""
Django settings for ec_prj project.
...
SECRET_KEY = 'django-insecure-c4iuji&%r$48p!cv77my*uncj^pea9*cy5bt26n4(fc)w)^e^i'
...
WSGI_APPLICATION = 'ec_prj.wsgi.application'
